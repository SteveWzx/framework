...
// module
exports.push([module.i, "body{font-size:12px}.src-css-common__bigBox--27sNb{border:2px solid #000}", ""]);

// exports
exports.locals = {
	"bigBox": "src-css-common__bigBox--27sNb"
};
...
// module
exports.push([module.i, "html{background:pink}.src-css-base__box--REzyU{height:200px;width:200px;-webkit-border-radius:20px;-moz-border-radius:20px;border-radius:20px;background:#333}", ""]);

// exports
exports.locals = {
	"box": "src-css-base__box--REzyU " + __webpack_require__(0).locals["bigBox"] + ""
};
