...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		methods: {
			homefn: function homefn(str) {
				document.write("<h1>homefn: this is " + str + "</h1>");
			},
			btn: function btn() {
				this.$children[0].listfn();
			}
		},
		...
		route: {
			data: function data(transition) {
				this.$root.appfn("home");
				this.$parent.appfn("home");
				transition.next();
			}
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n.link {\n\tcolor: blue;\n}\n", "", {"version":3,"sources":["/./src/views/page.vue?330cae73"],"names":[],"mappings":";AACA;CACA,YAAA;CACA","file":"page.vue","sourcesContent":["<style>\n\t.link {\n\t\tcolor: blue;\n\t}\n</style>\n\n<template>\n\t<div>\n\t\t<h1>PAGE</h1>\n\t\t<div class=\"link\" v-link=\"{name: 'home'}\">back</div>\n\t</div>\n</template>\n\n<script>\n\t\n</script>"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports) {
	...
	module.exports = {
		data: function data() {
			this.$root.appfn("list");
			this.$parent.homefn("list");
			return {};
		},
		methods: {
