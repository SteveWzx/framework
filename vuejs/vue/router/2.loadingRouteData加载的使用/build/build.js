...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  components: {},
	  methods: {
	    cancelfn: function cancelfn(type) {
	      if (!type) this.showModal = false;else this[type] = false;
	    },
	    openfn: function openfn(type, val) {
	      if (!type) this.showModal = true;else {
	
	        this.toast.content = val;
	      }
	    },
