...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/vue/createtopic.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _topicbox = __webpack_require__(83);
	...
	// <template>
	// 	<nv-header></nv-header>
	// 	<topic-box :accesstoken="accesstoken"></topic-box>
	// </template>
	// <script>
	exports.default = {
		data: function data() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/topicbox.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/.0.23.1@css-loader/index.js!./../../node_modules/.8.5.4@vue-loader/lib/style-rewriter.js!./../../node_modules/.3.2.3@sass-loader/index.js!./../../node_modules/.8.5.4@vue-loader/lib/selector.js?type=style&index=0!./topicbox.vue", function() {
				var newContent = require("!!./../../node_modules/.0.23.1@css-loader/index.js!./../../node_modules/.8.5.4@vue-loader/lib/style-rewriter.js!./../../node_modules/.3.2.3@sass-loader/index.js!./../../node_modules/.8.5.4@vue-loader/lib/selector.js?type=style&index=0!./topicbox.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".createtopic-box {\n  overflow: hidden;\n  margin: 0 5px;\n  padding-top: 4rem; }\n  .createtopic-box .createtopic-item {\n    width: 90%;\n    height: auto;\n    padding: 15px 5%; }\n    .createtopic-box .createtopic-item select {\n      width: 30%;\n      height: 1.5rem;\n      padding-left: 20px;\n      font-size: 0.8rem; }\n    .createtopic-box .createtopic-item input {\n      width: 100%;\n      height: 1.5rem;\n      font-size: 0.8rem; }\n    .createtopic-box .createtopic-item textarea {\n      width: 100%;\n      height: 6rem;\n      font-size: 0.8rem; }\n    .createtopic-box .createtopic-item .submit {\n      display: inline-block;\n      width: 10%;\n      height: 1.5rem;\n      background-color: #0088CC;\n      color: #fff;\n      font-size: 0.8rem;\n      text-align: center;\n      line-height: 1.5rem; }\n", ""]);
	...
	exports.default = {
		...
		watch: {
			topicId: function topicId() {
				...
				$.get('https://cnodejs.org/api/v1/topic/' + this.topicId, rqdata, function (data) {
					if (data.success) {
		...
		methods: {
			submitTopic: function submitTopic() {
				...
				$.post(url, rqdata, function (data) {
					if (data.success) {
						_this2.$route.router.go({ name: 'article', params: { id: data.topic_id } });
					}
				});
			}
		},
