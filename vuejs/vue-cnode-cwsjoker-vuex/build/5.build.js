...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/.0.23.1@css-loader/index.js!./../../node_modules/.8.5.4@vue-loader/lib/style-rewriter.js!./../../node_modules/.3.2.3@sass-loader/index.js!./../../node_modules/.8.5.4@vue-loader/lib/selector.js?type=style&index=0!./login.vue", function() {
				var newContent = require("!!./../../node_modules/.0.23.1@css-loader/index.js!./../../node_modules/.8.5.4@vue-loader/lib/style-rewriter.js!./../../node_modules/.3.2.3@sass-loader/index.js!./../../node_modules/.8.5.4@vue-loader/lib/selector.js?type=style&index=0!./login.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	exports.default = {
			...
			login: function login() {
				...
				$.post('https://cnodejs.org/api/v1/accesstoken', rqdata, function (data) {
					if (data) {
						...
						_this.hand_setUserInfo(data.loginname, data.avatar_url, data.id, _this.strToken);
						console.log(JSON.stringify(_this.ache_getUserInfo));
						if (_this.ache_getUserInfo) {
							// 获取消息
							$.get('https://cnodejs.org/api/v1/message/count', rqdata, function (d) {
								if (d.success) {
									_this.hand_setNotMessageCount(d.data);
									window.history.back();
								}
							});
						}
		...
		vuex: {
			actions: {
				...
				hand_setUserInfo: _actions.setUserInfo,
